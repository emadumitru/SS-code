...
if __name__ == "__main__":
    ...
    with open('cluster_results\\classification_accuracy_ratiocount_single.txt', 'w') as f:
        f.write(str(accs))
    with open('cluster_results\\classification_summary_ratiocount_single.pkl', 'wb') as f:
