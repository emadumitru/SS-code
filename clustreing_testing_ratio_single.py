...
def run_experiments_sequences(merged_df, refactorings, models, param_grids, test_splits, random_state=17):
    ...
    for refactoring in refactorings:
        ...
        for test_size in test_splits:
            ...
            X_train = extract_action_ratios(X_train)
            X_test = extract_action_ratios(X_test)
...
if __name__ == "__main__":
    ...
    with open('cluster_results\\classification_accuracy_ratio_single.txt', 'w') as f:
        f.write(str(accs))
    with open('cluster_results\\classification_summary_ratio_single.pkl', 'wb') as f:
